...
describe Apress::Utils::EmailValidation do
  ...
  context 'when email is valid' do
    it_behaves_like(
      ...
      %w{
        ...
        va-l-id_email@email.com
        validemail@email.com
        valid.email@e-mail.com
        valid_email@e.mail.com
        v3alid_email01@e.mail.com
        }
    )
  end
  ...
  context 'when email is invalid' do
    it_behaves_like(
      'invalid email',
      %w{
        inv&alidemail@email.com
        invalid.email@e_mail.com
        inv#alid-email@email.com
        envalid$email.com invalid@email
        }
    )
  end
end
